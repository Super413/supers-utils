...
## What is this?
This is my personal little stash of code utils I use or have used for various things. Generally, games are coded with Gemini pro, as HTML files with JS and CSS embedded. <br><br>Most are in a playable or semi-playable state, expect bugs.<br>If a game is interesting, I tend to fork it and develop it further on my own or with codex/cursor. <br> util scripts tba
